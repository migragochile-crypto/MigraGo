-- ============================================================
-- MigraciónChile — Seed v15b: parche (sin problemas/visa-vencida, ya existe)
-- Ejecutar en: Supabase Dashboard → SQL Editor
-- ============================================================

-- ──────────────────────────────────────────────────────────
-- 1. CLUSTER: problemas/sin-respuesta-sermig
-- ──────────────────────────────────────────────────────────
...
-- ──────────────────────────────────────────────────────────
-- 2. CLUSTER: visa-temporaria/responsabilidad-democratica
-- ──────────────────────────────────────────────────────────
INSERT INTO articles (
  slug, silo, parent_slug, type, title, h1, meta_description,
...
<ul>
  ...
  '[
    ...
    {"name": "Solicitar la visa temporaria que corresponda a tu situación", "text": "Una vez en Chile con permiso vigente, solicita la visa temporaria por la categoría que mejor aplique: trabajo, arraigo familiar, humanitaria, etc."},
...
<ul>
  ...
  <li>Si eres cónyuge del otro padre/madre chileno/a, puede haber vía directa a PD por vínculo conyugal.</li>
</ul>
  $r3$,
  'HowTo',
  '[
